...
namespace Crud.Controllers
{
    public class GrupoesController : Controller
    {
        ...
        public GrupoesController(GrupoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Codigo,Descricao,Status")] Grupo grupo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Codigo,Descricao,Status")] Grupo grupo)
        {
            if (id != grupo.Codigo)
            {
                return NotFound();
        ...
        {
            return _context.Grupo.Any(e => e.Codigo == id);
        }
    }
}
